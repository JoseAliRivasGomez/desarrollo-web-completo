...
Abrir usuario.php para insertar usuario

insert into vendedores (nombre, apellido, telefono) values ("Jose", "Rivas", "86354178");
insert into vendedores (nombre, apellido, telefono) values ("Juan", "Torres", "12345678");

insert into propiedades (titulo, precio, imagen, descripcion, habitaciones, wc, estacionamiento, vendedor_id, creado) values ("Casa Playa", 120000, "51a72e0366999677d501ec42437045e5.jpg", "Casa Playa en Promocion", 1, 1, 1, 1, '2023-06-21');
insert into propiedades (titulo, precio, imagen, descripcion, habitaciones, wc, estacionamiento, vendedor_id, creado) values ("Casa Playa 2", 130000, "51a72e0366999677d501ec42437045e5.jpg", "Casa Playa en Promocion", 1, 1, 1, 1, '2023-06-21');
insert into propiedades (titulo, precio, imagen, descripcion, habitaciones, wc, estacionamiento, vendedor_id, creado) values ("Casa Playa 3", 140000, "51a72e0366999677d501ec42437045e5.jpg", "Casa Playa en Promocion", 2, 2, 2, 1, '2023-06-21');
insert into propiedades (titulo, precio, imagen, descripcion, habitaciones, wc, estacionamiento, vendedor_id, creado) values ("Casa Playa 4", 150000, "51a72e0366999677d501ec42437045e5.jpg", "Casa Playa en Promocion", 3, 3, 3, 2, '2023-06-21');
insert into propiedades (titulo, precio, imagen, descripcion, habitaciones, wc, estacionamiento, vendedor_id, creado) values ("Casa Playa 5", 160000, "51a72e0366999677d501ec42437045e5.jpg", "Casa Playa en Promocion", 2, 2, 2, 2, '2023-06-21');
insert into propiedades (titulo, precio, imagen, descripcion, habitaciones, wc, estacionamiento, vendedor_id, creado) values ("Casa Playa 6", 170000, "51a72e0366999677d501ec42437045e5.jpg", "Casa Playa en Promocion", 3, 3, 3, 2, '2023-06-21');
